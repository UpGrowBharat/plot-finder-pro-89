    ...
    <section className="relative min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-green-100 flex items-center overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 relative z-10">
        ...
        <div className="max-w-5xl mx-auto mb-12 sm:mb-16 px-4">
          <div className="bg-white border border-gray-200 rounded-3xl p-4 sm:p-6 lg:p-8 shadow-lg">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    className="pl-10 sm:pl-12 h-10 sm:h-12 bg-white border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-xl text-gray-900"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <Select>
                  <SelectTrigger className="h-10 sm:h-12 bg-white border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-xl text-gray-900">
                    <SelectValue placeholder="Select Type" />
                  </SelectTrigger>
                  <SelectContent className="bg-white border-gray-200">
                    <SelectItem value="residential" className="text-gray-900">Residential Plot</SelectItem>
                    <SelectItem value="commercial" className="text-gray-900">Commercial Plot</SelectItem>
                    <SelectItem value="industrial" className="text-gray-900">Industrial Plot</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <Select>
                  ...
                  <SelectContent className="bg-white border-gray-200">
                    <SelectItem value="1-10" className="text-gray-900">₹1L - ₹10L</SelectItem>
                    <SelectItem value="10-25" className="text-gray-900">₹10L - ₹25L</SelectItem>
                    <SelectItem value="25-50" className="text-gray-900">₹25L - ₹50L</SelectItem>
                    <SelectItem value="50-100" className="text-gray-900">₹50L - ₹1Cr</SelectItem>
                    <SelectItem value="100+" className="text-gray-900">₹1Cr+</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="flex items-end">
                <Button 
                  className="w-full h-10 sm:h-12 bg-green-600 hover:bg-green-700 text-white rounded-xl font-semibold transition-all duration-300 hover:scale-105"
                >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 animate-slide-in px-4">
          {[
            ...
            <div key={index} className="text-center group">
              <div className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105">
                <div className="text-2xl sm:text-3xl mb-2">{stat.icon}</div>
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-green-600 mb-2 group-hover:scale-110 transition-transform duration-300">
                  {stat.number}
                </div>
